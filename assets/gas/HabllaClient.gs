// GENERATED by tooling/build-gas.js from the hablla SDK v0.1.15. Do not edit.
...
(() => {
  ...
  var FIRST_NAME_FIELD = { name: "Primeiro Nome", stdName: "cf_primeiro_nome", type: "string", target: "person", fallbackId: "6a58642a4d7c0aa11db4d93e" };
  ...
  var MassDispatch = class {
    ...
    ensureFirstNameField() {
      return __async(this, null, function* () {
        ...
        return { id: (_d = created == null ? void 0 : created.id) != null ? _d : FIRST_NAME_FIELD.fallbackId, stdName: FIRST_NAME_FIELD.stdName, type: FIRST_NAME_FIELD.type };
      });
    }
    /**
