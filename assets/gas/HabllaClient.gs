// GENERATED by tooling/build-gas.js from the hablla SDK v0.1.14. Do not edit.
...
(() => {
  ...
  var CUSTOM_FIELD_PAGE_LIMIT = 500;
  var MassDispatch = class {
    ...
    ensureFirstNameField() {
      return __async(this, null, function* () {
        var _a, _b, _c, _d;
        const page = yield this.client.customFields.listCustomFields({ query: { target: FIRST_NAME_FIELD.target, limit: CUSTOM_FIELD_PAGE_LIMIT } });
        const existing = ((_a = page.results) != null ? _a : []).find(
