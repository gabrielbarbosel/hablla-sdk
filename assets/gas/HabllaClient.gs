// GENERATED by tooling/build-gas.js from the hablla SDK v0.1.3. Do not edit.
    ...
    run(input, spec) {
      return __async(this, null, function* () {
        ...
        try {
          ...
          yield this.settleAttendance(person.id, spec, advisor == null ? void 0 : advisor.id);
          return { status: created ? "criado_enviado" : closedExisting ? "atendimento_encerrado_enviado" : "enviado", person: person.id, assessor: advisor == null ? void 0 : advisor.name, created };
        } catch (error) {
