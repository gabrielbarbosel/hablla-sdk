// GENERATED by tooling/build-gas.js from the hablla SDK v0.1.13. Do not edit.
  ...
  var MassDispatch = class {
    ...
    importContacts(contacts, opts) {
      return __async(this, null, function* () {
        ...
        const columns = (_a = opts.spec.columns) != null ? _a : DEFAULT_COLUMNS;
        ...
        const data = {
          ...
          update_duplicates: (_d = (_c = opts.spec.importOptions) == null ? void 0 : _c.update_duplicates) != null ? _d : true,
          allow_duplicates: (_f = (_e = opts.spec.importOptions) == null ? void 0 : _e.allow_duplicates) != null ? _f : false,
    ...
    waitForAudience(segmentationId, expected, timeoutMs, sleep2) {
      return __async(this, null, function* () {
        ...
        for (let attempt = 0; attempt < deadline; attempt++) {
          ...
          const seg = yield this.client.segmentations.getSegmentation(segmentationId);
          last = (_a = seg.counter) != null ? _a : 0;
    ...
    sendCampaign(opts) {
      return __async(this, null, function* () {
        ...
        const body = {
          ...
          type: "whatsapp",
          name: (_a = spec.name) != null ? _a : "mass-dispatch",
          dispatch_config: (_b = spec.dispatchConfig) != null ? _b : DEFAULT_PACING,
          types: ["whatsapp", "gupshup"],
          connection: spec.connectionId,
          template: spec.templateId,
          variables: { body: (_c = spec.variables) != null ? _c : [] },
