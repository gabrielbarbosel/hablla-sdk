...
export class CustomFields extends Resource {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    getCustomField(customFieldId: string, opts: { query?: Record<string, unknown> } = {}): Promise<unknown> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    updateCustomField(customFieldId: string, body: Record<string, unknown>, opts: { query?: Record<string, unknown> } = {}): Promise<unknown> {
