...
export class Annotations extends Resource {
     ...
     */
    getAnnotation(annotationId: string, opts: { query?: { filters?: string } & Record<string, unknown> } = {}): Promise<unknown> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    updateAnnotation(annotationId: string, body: Record<string, unknown>, opts: { query?: Record<string, unknown> } = {}): Promise<unknown> {
     ...
     */
    listAnnotations(opts: { query?: { filters?: string; page?: string; limit?: number; order?: string; direction_order?: string; person?: string; card?: string; service?: string; organization?: string; description?: string; type?: string; populate?: string[]; is_fixed?: boolean } & Record<string, unknown> } = {}): Promise<unknown> {
     ...
     */
    createAnnotation(file: MultipartFile, fields?: Record<string, string>, opts: { query?: Record<string, unknown> } = {}): Promise<unknown> {
