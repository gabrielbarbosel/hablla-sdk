...
export class Sectors extends Resource {
     ...
     */
    getSectorsUsers(id: string, opts: { query?: { filters?: string; page?: string; limit?: number; order?: string; direction_order?: string; name?: string; email?: string; is_attendant?: boolean; role_type?: string } & Record<string, unknown> } = {}): Promise<Paged<Sector>> {
     ...
     * @remarks Documented query: filters, sector (extra keys allowed).
     */
    getUserById(userId: string, opts: { query?: { filters?: string; sector?: boolean } & Record<string, unknown> } = {}): Promise<Sector> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    listUsers(opts: { query?: Record<string, unknown> } = {}): Promise<Paged<Sector>> {
