...
export class Cards extends Resource {
     ...
     */
    createOrUpdate(body: Partial<Card>, opts: { query?: { page?: number; limit?: number; order?: string; direction_order?: string; name?: string; search?: string; campaign?: string; source?: string; id?: string; list?: string; custom_id?: string; board?: string; person?: string; organization?: string; user?: string; product?: string; service?: string; status?: CardStatusCode; rating?: string; tags?: string[]; start_date?: string; end_date?: string; field_date?: string; created_at?: string; updated_at?: unknown; prediction_date?: unknown; next_task_start_date?: unknown; next_task_type?: TaskTypeCode; has_next_task?: string; custom_fields?: string[]; update_rule?: string } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    listCardsV1(opts: { query?: { page?: string; limit?: number; order?: string; direction_order?: string; name?: string; search?: string; campaign?: string; source?: string; list?: string; custom_id?: string; board?: string; person?: string; organization?: string; user?: string; product?: string; service?: string; sector?: string; status?: CardStatusCode; rating?: string; tags?: string[]; followers?: string[]; users?: string[]; populate?: string[]; start_date?: string; end_date?: string; field_date?: string; created_at?: string; updated_at?: unknown; finished_at?: unknown; prediction_date?: unknown; entry_date?: unknown; next_task_start_date?: unknown; next_task_type?: TaskTypeCode; has_next_task?: string; custom_fields?: string[]; highlight_old_cards?: boolean } & Record<string, unknown> } = {}): Promise<Paged<Card>> {
