...
export class Cards extends Resource {
     ...
     */
    addFollowers(id: string, body: Partial<Card>, opts: { query?: { followers?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    addPersons(id: string, body: Partial<Card>, opts: { query?: { persons?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    addTags(id: string, body: Partial<Card>, opts: { query?: { tags?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    deleteChecklist(id: string, checklistId: string, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<void> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    putChecklist(id: string, checklistId: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    checklist(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    getCosts(id: string, opts: { query?: { filters?: string; page?: string; limit?: number; order?: string; direction_order?: string; entity_type?: string; start_date?: string; end_date?: string; populate?: string[] } & Record<string, unknown> } = {}): Promise<Paged<Card>> {
     ...
     */
    move(id: string, body: Partial<Card>, opts: { query?: { list?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    putPaymentInterval(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    putProductsPrices(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    createProductsBatch(id: string, body: Partial<Card>, opts: { query?: Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    getPurge(id: string, opts: { query?: Record<string, unknown> } = {}): Promise<Paged<Card>> {
     ...
     */
    removeFollowers(id: string, body: Partial<Card>, opts: { query?: { followers?: string } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    removePaymentInterval(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: persons, flow_execution, user (extra keys allowed).
     */
    removePersons(id: string, body: Partial<Card>, opts: { query?: { persons?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    removeProductsPrices(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     */
    removeTags(id: string, body: Partial<Card>, opts: { query?: { tags?: string } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    deleteCard(id: string, opts: { query?: Record<string, unknown> } = {}): Promise<void> {
     ...
     */
    getCard(id: string, opts: { query?: { params?: string; flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Documented query: flow_execution, user (extra keys allowed).
     */
    updateCard(id: string, body: Partial<Card>, opts: { query?: { flow_execution?: boolean; user?: boolean } & Record<string, unknown> } = {}): Promise<Card> {
     ...
     * @remarks Any query params may be sent (none documented).
     */
    createBatch(body: Partial<Card>, opts: { query?: Record<string, unknown> } = {}): Promise<Card> {
